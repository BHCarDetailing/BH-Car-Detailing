...
export const NAV_GROUPS: NavGroup[] = [
  {
    title: "Overview",
    items: [
      { to: "/home", label: "Home", short: "Home", icon: "M3 11l9-8 9 8M5 10v10h14V10z", keywords: "start overview" },
      { to: "/dashboard", label: "Dashboard", short: "Board", icon: "M4 4h7v7H4zM13 4h7v7h-7zM4 13h7v7H4zM13 13h7v7h-7z", keywords: "metrics revenue" },
    ],
  },
  {
    title: "Growth",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/sequences", label: "Sequences", short: "Sequences", icon: "M3 5h4v4H3zM3 15h4v4H3zM10 7h11M10 17h11", keywords: "email nurture automation" },
      ...
      { to: "/settings", label: "Settings", short: "Settings", icon: "M12 15a3 3 0 100-6 3 3 0 000 6M19.4 15a1.7 1.7 0 00.3 1.9l.1.1a2 2 0 11-2.8 2.8l-.1-.1a1.7 1.7 0 00-2.9 1.2V21a2 2 0 11-4 0v-.1A1.7 1.7 0 007 19.7l-.1.1a2 2 0 11-2.8-2.8l.1-.1A1.7 1.7 0 004 15M20 12h.1M3.9 12H4", keywords: "config integrations" },
    ],
  },
];
...
/** Curated bottom-nav for mobile (space is limited). */
export const BOTTOM_NAV: NavItem[] = [
  NAV_ITEMS.find((i) => i.to === "/home")!,
  NAV_ITEMS.find((i) => i.to === "/dashboard")!,
  NAV_ITEMS.find((i) => i.to === "/clients")!,
  NAV_ITEMS.find((i) => i.to === "/accountability")!,
  NAV_ITEMS.find((i) => i.to === "/ask")!,
];
